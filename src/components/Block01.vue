<template>
    <div class="flex items-center justify-center h-screen bg-gradient-to-br from-gray-800 to-gray-900">
        <div class="bg-base-200 font-semibold text-center rounded-3xl border shadow-lg p-10">
            <div class="avatar cursor-pointer " @click="randomTheme">
                <div class="
                w-24
                rounded-full
            ...
            <h1 class="text-lg text-base-content">Mario Jose Goes Tarosso </h1>
            <h3 class="text-sm text-base-content "> Web and game developer </h3>
            <p class="text text-base-content mt-4 p-5">I'm Mario Jose Goes Tarosso, a creative developer and content creator passionate about open source projects.  </p>
            <!-- tags start -->
            <div class="space-x-1" >
                <div class="badge badge-lg">Laravel</div>
                <div class="badge badge-lg badge-primary">Unreal Engine</div>
                <div class="badge badge-lg badge-secondary">php</div>
                <div class="badge badge-lg badge-accent">vue js</div>
                <div class="badge badge-lg badge-outline">Tailwind</div>
                <div class="badge badge-lg badge-secondary">Node js</div>
            </div>

            <div class="btn-group pt-5">
                    <a href="https://github.com/mariojgt" class="btn btn-warning"><svg
                    ...
                    <a href="https://www.linkedin.com/in/mariojgt/" class="btn btn-warning"><svg
                            xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24">
                            <path
                                d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" />
                        </svg></a>
                    <a href="https://www.youtube.com/channel/UC6wn6zd5JYJa3rzx1B12Orw/videos" class="btn btn-dark">
		...
		c0-3.774,3.982-6.22,7.348-4.514l126.06,63.881C304.363,229.873,304.298,235.248,300.506,237.056z" />
                    ...
                    <a href="https://www.udemy.com/user/mario-jose-goes-tarosso/" class="btn btn-dark">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 144 64" width="40" height="40">
                            <path
